...
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by Ibrahim Lawal</h6>", unsafe_allow_html = True)

# Add an image to the page
st.image('pngwing.com(45).png', caption = 'FACE DETECTOR', width = 400)
